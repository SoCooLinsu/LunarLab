...
All the environments are registered in the `LunarLab` extension. They start
...
import LunarLab.tasks  # noqa: F401


def main():
    """Print all environments registered in `LunarLab` extension."""
